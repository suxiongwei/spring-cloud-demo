...
@RocketMQMessageListener(topic = "${demo.rocketmq.topics.tx}",
        consumerGroup = "${demo.rocketmq.consumer-groups.tx-consumer}",
        selectorExpression = "ORDER_PAY_SUCCESS",
        consumeMode = ConsumeMode.CONCURRENTLY,
        messageModel = MessageModel.CLUSTERING)
public class TxScenarioConsumerListener implements RocketMQListener<MessageExt> {
    ...
    public void onMessage(MessageExt messageExt) {
        ...
        runtimeState.markTxDelivered(message.getTransactionId());
    }
}
