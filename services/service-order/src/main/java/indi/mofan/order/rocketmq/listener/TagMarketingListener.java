...
@RocketMQMessageListener(topic = "${demo.rocketmq.topics.tag}",
        consumerGroup = "${demo.rocketmq.consumer-groups.tag-marketing}",
        selectorExpression = "MARKETING",
        consumeMode = ConsumeMode.CONCURRENTLY,
        messageModel = MessageModel.CLUSTERING)
public class TagMarketingListener implements RocketMQListener<MessageExt> {
    ...
    public void onMessage(MessageExt messageExt) {
        ...
        runtimeState.recordTagDelivery(message.getMessageKey(), properties.getConsumerGroups().getTagMarketing());
    }
}
