 ...
 */
@Slf4j
@DubboService(version = "1.0.0", group = "product-v1", timeout = 2000, retries = 2)
public class ProductDubboV1ServiceImpl implements IProductDubboService {

    /**
     * 模拟产品数据库
     */
    private static final List<Product> PRODUCTS = Arrays.asList(
            new Product(1L, new BigDecimal("110"), "产品名-V1", 10),
            new Product(2L, new BigDecimal("1110"), "产品名1-V1", 11),
            new Product(3L, new BigDecimal("113210"), "产品名2-V1", 12),
            new Product(4L, new BigDecimal("22"), "产品名3-V1", 13),
            new Product(5L, new BigDecimal("323"), "产品名4-V1", 14));
